...
Run .husky/pre-commit before committing to ensure type checks, linting, formatting, and changeset creation are all done. The pre-commit hook will block the commit if any of these steps fail.
